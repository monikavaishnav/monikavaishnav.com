...
import { Bebas_Neue, Caveat, Inter as CarmesiInter, Luckiest_Guy } from "next/font/google";
...
const carmesiInter = CarmesiInter({
  subsets: ["latin"],
  weight: ["400", "500", "600", "700"],
  variable: "--font-carmesi-inter",
  display: "swap",
});
    ...
    <>
      <style>{`
        .carmesi-work{
          ...
          --font-body:var(--font-carmesi-inter), system-ui, -apple-system, sans-serif;
          --font-note:var(--font-caveat), cursive;
          ...
          background:var(--bg);
          background-image:
            radial-gradient(circle at 15% 10%, rgba(200,30,58,0.18), transparent 40%),
            radial-gradient(circle at 90% 85%, rgba(232,163,61,0.10), transparent 45%);
        ...
        .carmesi-work *{box-sizing:border-box;}
      ...
      <div
        className={`carmesi-work ${bebasNeue.variable} ${luckiestGuy.variable} ${caveat.variable} ${carmesiInter.variable}`}
      >
